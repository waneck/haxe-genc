...
genswf9 genswf genjava gencs analyzer genc interp dce filters typer matcher version main
...
analyzer.cmx: type.cmx ast.cmx

genc.cmx: type.cmx common.cmx codegen.cmx analyzer.cmx ast.cmx
...
main.cmx: dce.cmx filters.cmx matcher.cmx typer.cmx typeload.cmx typecore.cmx type.cmx parser.cmx optimizer.cmx lexer.cmx interp.cmx genxml.cmx genswf.cmx genphp.cmx genneko.cmx genjs.cmx gencpp.cmx genas3.cmx genc.cmx common.cmx codegen.cmx ast.cmx gencommon.cmx genjava.cmx gencs.cmx version.cmx
